...
(4, '2016-12-01', '2019-05-26', 1050, 29, 'Vespertino', 'Finalizado', 32),
...
--
ALTER TABLE `pruebas`
  ADD CONSTRAINT `FK_PRUEBAS_1` FOREIGN KEY (`id_cita`) REFERENCES `citas` (`id_cita`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
